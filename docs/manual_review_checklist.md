...
Use this checklist to review the Phase 0A output and verify that the Stage2 contract has not gone beyond the approved scope.
...
- [ ] Is D0-2 still in `PENDING_USER_DECISION` status?
